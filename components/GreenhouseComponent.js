...
const GreenhouseComponent = () => {
  ...
  const toggleSwitch = () => {
    ...
    setImageSource(previousState => previousState === require('../assets/lamp.png') ? require('../assets/Light.png') : require('../assets/lamp.png'));
  };
  const [isEnable, setIsEnable] = useState(false);
  const toggleFan = () => setIsEnable(previousState => !previousState);
